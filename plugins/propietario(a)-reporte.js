...
if (!text) throw `*[❗] نسيت التقرير - البلاغ*\n\n*مثال:*\n*${usedPrefix + command} الامر ${usedPrefix}لويد عمكم*`
...
let teks = `*❒═════[ تحذير ]═════❒*\n*┬*\n*├❧ الرقم:* wa.me/4917672339436${m.sender.split`@`[0]}\n*┴*\n*┬*\n*├❧ رسالة:* ${text}\n*┴*`
conn.reply('wa.me/4917672339436', m.quoted ? teks + m.quoted.text : teks, null, {
contextInfo: {
